            ...
            <div align="center">
                <div class="layui-form-item" style="margin-top: 30px">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="className" lay-verify="required" class="layui-input" id="className">
                    </div>
                </div>

                <div class="layui-form-item">
                    <label class="layui-form-label">添加老师</label>
    ...
    layui.use('form', function () {
        ...
        $("#add").click(function () {
            if ($("#className").val() == null || $("#className").val() == "") {
                layer.msg("班级名称不能为空")
            }else  if ($("#teacherFilter").val() ==null ||$("#teacherFilter").val() == ""){
